<?
	...
	$query="INSERT INTO MeongUnRecommendApp(no,src,url,title,detail) VALUES(NULL,'$imgurl','".$_POST['url']."','".$_POST['title']."','".$_POST['detail']."')";
  mysqli_query($con,$query);
	$ret=mysqli_query($conn,$query);

	echo "<script>alert(\"".$query."\");location.href=\"adminRecommendApp.php\"</script>";
?>
